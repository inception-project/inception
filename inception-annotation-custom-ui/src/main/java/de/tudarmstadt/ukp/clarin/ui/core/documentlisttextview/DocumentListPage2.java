package de.tudarmstadt.ukp.clarin.ui.core.documentlisttextview;
 ...
 */
//@MenuItem(icon = "images/information.png", label = "Text View Annotation")
@MountPath("/DocumentListPage2.html")
public class DocumentListPage2

 ...
 */
package de.tudarmstadt.ukp.inception.pdfeditor.pdfjs;
    ...
    extends Panel
{
    ...
    public PdfJsPanel(String aId, IModel<AnnotatorState> aModel)
    {
        super(aId, aModel);

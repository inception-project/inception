        ...
        throws Exception
    {
        ...
        aHttp
            ...
            .authorizeRequests()
                ...
                .requestMatchers("/swagger-ui/**").access("hasAnyRole('ROLE_REMOTE')")
                .requestMatchers("/swagger-ui.html").access("hasAnyRole('ROLE_REMOTE')")
                .requestMatchers("/v3/**").access("hasAnyRole('ROLE_REMOTE')")
                .requestMatchers("/admin/**").access("hasAnyRole('ROLE_ADMIN')")
                .requestMatchers("/doc/**").access("hasAnyRole('ROLE_ADMIN', 'ROLE_USER')")
                .requestMatchers("/**").access("hasAnyRole('ROLE_ADMIN', 'ROLE_USER')")
                .anyRequest().denyAll()
            .and()
            .exceptionHandling()

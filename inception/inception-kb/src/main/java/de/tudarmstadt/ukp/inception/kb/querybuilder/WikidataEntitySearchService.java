...
public class WikidataEntitySearchService
    implements GraphPattern
{
    private static final Prefix WIKIBASE = prefix("wikibase", iri("http://wikiba.se/ontology#"));
    private static final Prefix MWAPI = prefix("mwapi",
            iri("https://www.mediawiki.org/ontology#API/"));
     ...
     * 
     * @param aSubject
     *            the variable to which the matching item IRIs are to be bound.
     * @param aQuery
     *            the query term. The search does not appear to support wildcards.
     * @param aLanguage

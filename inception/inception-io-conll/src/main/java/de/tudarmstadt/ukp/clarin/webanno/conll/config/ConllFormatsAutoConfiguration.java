...
{
    @Bean
    @ConditionalOnProperty(prefix = "format.conll2000", name = "enabled", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(prefix = "format.conll2002", name = "enabled", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(prefix = "format.conll2003", name = "enabled", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(prefix = "format.conll2006", name = "enabled", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(prefix = "format.conll2009", name = "enabled", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(prefix = "format.conll2012", name = "enabled", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(prefix = "format.conllcorenlp", name = "enabled", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(prefix = "format.conllu", name = "enabled", havingValue = "true", matchIfMissing = true)

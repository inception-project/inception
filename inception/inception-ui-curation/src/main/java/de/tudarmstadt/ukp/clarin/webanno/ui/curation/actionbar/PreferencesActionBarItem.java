...
/**
 * @deprecated Superseded by the preferences item in the sidebar footer. Retained only for
 *             {@link de.tudarmstadt.ukp.clarin.webanno.ui.curation.page.LegacyCurationPage}, which
 *             has no sidebar to host that item. Remove along with the legacy curation page.
 */
@Deprecated

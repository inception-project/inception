...
@Order(2500)
public class CurationUnitOverviewSidebarFactory
    extends AnnotationSidebarFactory_ImplBase
{
    ...
    {
        return "Shows the units of the document and indicates their curation status. "
                + "Only available on the curation pages.";
    }

    @Override
    public Component createIcon(String aId, IModel<AnnotatorViewState> aState)
    {
        return new Icon(aId, FontAwesome7IconType.table_cells_s);
    }

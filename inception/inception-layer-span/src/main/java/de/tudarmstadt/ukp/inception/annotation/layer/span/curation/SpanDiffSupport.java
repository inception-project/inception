    ...
    implements DiffSupport
{
    ...
    @Override
    public SpanDiffAdapter getAdapter(AnnotationLayer aLayer, Set<String> featuresToCompare)
    {
        return new SpanDiffAdapterImpl(aLayer.getName(), featuresToCompare);
    }
}

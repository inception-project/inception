...
public class EvalChartPanel extends VueComponent
{
    private static final long serialVersionUID = 1L;
    private final Logger log = LoggerFactory.getLogger(EvalChartPanel.class);
    
    private @SpringBean ServletContext servletContext;

    public EvalChartPanel(String aId)
    {
        super(aId, "EvalChartPanel.vue");
    }

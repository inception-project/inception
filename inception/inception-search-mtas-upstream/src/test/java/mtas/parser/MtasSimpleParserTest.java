...
public class MtasSimpleParserTest
{
    ...
    private void testSimpleParse(String field, String defaultPrefix, String simple, MtasSpanQuery q)
    {
    ...
    {
        MtasSimpleParser p = new MtasSimpleParser(new BufferedReader(new StringReader(simple)));
        try {
     ...
     *            the default prefix
     * @param simple1
     *            the first simple expression
     * @param simple2
     *            the second simple expression
     */
    private void testSimpleEquivalent(String field, String defaultPrefix, String simple1,
            String simple2)
    {
        MtasSimpleParser p1 = new MtasSimpleParser(new BufferedReader(new StringReader(simple1)));
        MtasSimpleParser p2 = new MtasSimpleParser(new BufferedReader(new StringReader(simple2)));
        try {
    ...
    public void singleWordSequence() throws ParseException
    {
        ...
        for (String word : words) {
            qList.add(new MtasSpanSequenceItem(new MtasSimpleParserWordQuery(field, prefix, word),
                    false));
        }
        MtasSpanQuery q = new MtasSpanSequenceQuery(qList, null, null);
        testSimpleParse(field, prefix, simple, new MtasSpanUniquePositionQuery(q));
    ...
    public void singleWordSequenceEscape() throws ParseException
    {
        ...
        String simple = "\"een \\\"echte\\\" test\"";
        List<MtasSpanSequenceItem> qList = new ArrayList<>();
        qList.add(new MtasSpanSequenceItem(new MtasSimpleParserWordQuery(field, prefix, "een"),
                false));
        qList.add(new MtasSpanSequenceItem(
                new MtasSimpleParserWordQuery(field, prefix, "\"echte\""), false));
        qList.add(new MtasSpanSequenceItem(new MtasSimpleParserWordQuery(field, prefix, "test"),
                false));
        MtasSpanQuery q = new MtasSpanSequenceQuery(qList, null, null);
        testSimpleParse(field, prefix, simple, new MtasSpanUniquePositionQuery(q));
    }
    ...
    public void singleWordSequenceBracket() throws ParseException
    {
        ...
        qList.add(new MtasSpanSequenceItem(new MtasSimpleParserWordQuery(field, prefix, "een"),
                false));
        qList.add(new MtasSpanSequenceItem(new MtasSimpleParserWordQuery(field, prefix, "echte"),
                false));
        qList.add(new MtasSpanSequenceItem(new MtasSimpleParserWordQuery(field, prefix, "test"),
                false));
        MtasSpanQuery q = new MtasSpanSequenceQuery(qList, null, null);
    ...
    public void multipleWords() throws ParseException
    {
        ...
        List<MtasSpanQuery> qList = new ArrayList<>();
        for (String word : words) {
            qList.add(new MtasSpanUniquePositionQuery(
                    new MtasSimpleParserWordQuery(field, prefix, word)));
        }
    ...
    public void multipleWordsAndSequences() throws ParseException
    {
        ...
        sList.add(new MtasSpanSequenceItem(new MtasSimpleParserWordQuery(field, prefix, "paard"),
                false));
        sList.add(new MtasSpanSequenceItem(new MtasSimpleParserWordQuery(field, prefix, "schaap"),
                false));
        qList.add(new MtasSpanUniquePositionQuery(
                new MtasSimpleParserWordQuery(field, prefix, "koe")));
        qList.add(new MtasSpanUniquePositionQuery(new MtasSpanSequenceQuery(sList, null, null)));
        qList.add(new MtasSpanUniquePositionQuery(
                new MtasSimpleParserWordQuery(field, prefix, "geit")));
        testSimpleParse(field, prefix, simple, qList);
    }

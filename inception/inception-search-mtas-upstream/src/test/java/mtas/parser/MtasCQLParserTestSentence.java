...
public class MtasCQLParserTestSentence
{
    ...
    public void basicTestCQL10() throws ParseException
    {
        ...
        items.add(
                new MtasSpanSequenceItem(new MtasSpanRecurrenceQuery(q2, 1, 3, null, null), false));
        items.add(new MtasSpanSequenceItem(q3, false));
        MtasSpanQuery q = new MtasSpanSequenceQuery(items, null, null);
        testCQLParse(field, null, cql, new MtasSpanUniquePositionQuery(q));
    }
    ...
    public void basicTestCQL27() throws ParseException
    {
        ...
        MtasSpanQuery q1 = new MtasCQLParserGroupQuery(field, "sentence", ".*",
                MtasCQLParserGroupQuery.MTAS_CQL_REGEXP_QUERY);
        MtasSpanQuery q2 = new MtasCQLParserGroupQuery(field, "sentence", ".*",
                MtasCQLParserGroupQuery.MTAS_CQL_TERM_QUERY);
    ...
    public void basicTestCQL28() throws ParseException
    {
        ...
        MtasSpanQuery q1 = new MtasCQLParserGroupOperatorQuery(field, "sentence",
                MtasSpanOperatorQuery.MTAS_OPERATOR_EQUAL, 100);
        MtasSpanQuery q2 = new MtasCQLParserGroupOperatorQuery(field, "sentence",
                MtasSpanOperatorQuery.MTAS_OPERATOR_LESS_THAN, 100);
        MtasSpanQuery q3 = new MtasCQLParserGroupOperatorQuery(field, "sentence",
                MtasSpanOperatorQuery.MTAS_OPERATOR_LESS_THAN_OR_EQUAL, 100);
        MtasSpanQuery q4 = new MtasCQLParserGroupOperatorQuery(field, "sentence",
                MtasSpanOperatorQuery.MTAS_OPERATOR_MORE_THAN, 100);
        MtasSpanQuery q5 = new MtasCQLParserGroupOperatorQuery(field, "sentence",
                MtasSpanOperatorQuery.MTAS_OPERATOR_MORE_THAN_OR_EQUAL, 100);
        testCQLParse(field, null, cql1, new MtasSpanUniquePositionQuery(q1));
        testCQLParse(field, null, cql2, new MtasSpanUniquePositionQuery(q2));

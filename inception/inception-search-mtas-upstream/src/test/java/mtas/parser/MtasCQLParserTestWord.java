...
public class MtasCQLParserTestWord
{
    ...
    public void basicTestCQL1() throws ParseException
    {
        ...
        MtasSpanQuery q2 = new MtasCQLParserWordQuery(field, "lemma", ".",
                MtasCQLParserWordQuery.MTAS_CQL_REGEXP_QUERY, null, null);
        MtasSpanQuery q3 = new MtasCQLParserWordQuery(field, "lemma", ".",
                MtasCQLParserWordQuery.MTAS_CQL_TERM_QUERY, null, null);
    ...
    public void basicTestCQL14() throws ParseException
    {
        ...
        String cql4 = "[t>=34]";
        String cql5 = "[t=34]";
        MtasSpanQuery q1 = new MtasCQLParserWordOperatorQuery(field, "t",
                MtasSpanOperatorQuery.MTAS_OPERATOR_LESS_THAN, 34);
        MtasSpanQuery q2 = new MtasCQLParserWordOperatorQuery(field, "t",
                MtasSpanOperatorQuery.MTAS_OPERATOR_MORE_THAN, 34);
        MtasSpanQuery q3 = new MtasCQLParserWordOperatorQuery(field, "t",
                MtasSpanOperatorQuery.MTAS_OPERATOR_LESS_THAN_OR_EQUAL, 34);
        MtasSpanQuery q4 = new MtasCQLParserWordOperatorQuery(field, "t",
                MtasSpanOperatorQuery.MTAS_OPERATOR_MORE_THAN_OR_EQUAL, 34);
        MtasSpanQuery q5 = new MtasCQLParserWordOperatorQuery(field, "t",
                MtasSpanOperatorQuery.MTAS_OPERATOR_EQUAL, 34);

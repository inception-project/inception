 ...
 */
public class MtasCQLParserWordQuery
    extends MtasSpanQuery
{
     ...
     *            the variables
     */
    public MtasCQLParserWordQuery(String field, String prefix, Map<String, String[]> variables)
    {
        super(1, 1);
        ...
        throws ParseException
    {
        ...
        if (type.equals(MTAS_CQL_REGEXP_QUERY)) {
            ...
            query = new MtasSpanOperatorQuery(field, prefix,
                    MtasSpanOperatorQuery.MTAS_OPERATOR_DEQUAL, value, true);
        }
        else if (type.equals(MTAS_CQL_VARIABLE_REGEXP_QUERY)
                || type.equals(MTAS_CQL_VARIABLE_TERM_QUERY)) {

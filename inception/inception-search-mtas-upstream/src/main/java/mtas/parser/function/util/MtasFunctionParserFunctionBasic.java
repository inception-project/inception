    ...
    extends MtasFunctionParserFunction
{
     ...
     *             the parse exception
     */
    public MtasFunctionParserFunctionBasic(MtasFunctionParserItem item) throws ParseException
    {
        sumRule = true;
     ...
     *             the parse exception
     */
    private void basic(String operator, MtasFunctionParserItem item) throws ParseException
    {
        if (!defined()) {
            String type = item.getType();
            MtasFunctionParserFunction parser;
    ...
    public double getValueDouble(long[] argsQ, long[] argsD, long n, long d) throws IOException
    {
        ...
        for (int i = 0; i < number; i++) {
            ...
            case BASIC_OPERATOR_POWER:
                ...
                case MtasFunctionParserItem.TYPE_PARSER_DOUBLE:
                    sum = Math.pow(sum,
                            parserDoubles[idList[i]].getValueDouble(argsQ, argsD, n, d));
                    break;
                case MtasFunctionParserItem.TYPE_PARSER_LONG:
            ...
            for (int i = 0; i < number; i++) {
                ...
                case BASIC_OPERATOR_POWER:
                    ...
                    case MtasFunctionParserItem.TYPE_ARGUMENT_D:
                        ...
                        break;
                    case MtasFunctionParserItem.TYPE_PARSER_DOUBLE:
                        sum = sum ^ (long) parserDoubles[idList[i]].getValueDouble(argsQ, argsD, n,
                                d);
                        break;
                    case MtasFunctionParserItem.TYPE_PARSER_LONG:

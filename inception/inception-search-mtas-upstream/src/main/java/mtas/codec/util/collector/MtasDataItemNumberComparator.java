    ...
    implements Comparable<T>, Serializable, Cloneable
{
     ...
     *             Signals that an I/O exception has occurred.
     */
    public MtasDataItemNumberComparator<T> recomputeBoundary(int n) throws IOException
    {
        if (sortDirection.equals(CodecUtil.SORT_DESC)) {
            if (value instanceof Integer) {
                return new MtasDataItemNumberComparator(Math.floorDiv((Integer) value, n),
                        sortDirection);
            }
                ...
                return new MtasDataItemNumberComparator(((Float) value) / n, sortDirection);
            }
            else if (value instanceof Double) {
                return new MtasDataItemNumberComparator(((Double) value) / n, sortDirection);
            }
            else {

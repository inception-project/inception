...
public class MtasDataDoubleAdvanced
    extends MtasDataAdvanced<Double, Double>
{
     ...
     */
    public MtasDataDoubleAdvanced(String collectorType, SortedSet<String> statsItems,
            ...
            Integer[] subStart, Integer[] subNumber, String segmentRegistration, String boundary)
        throws IOException
    {
    ...
    protected final MtasDataItemDoubleAdvanced getItem(int i)
    {
        if (i >= 0 && i < size) {
            return new MtasDataItemDoubleAdvanced(advancedValueSumList[i],
                    ...
                    advancedValueMinList[i], advancedValueMaxList[i], advancedValueNList[i],

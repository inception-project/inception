...
abstract class MtasDataAdvanced<T1 extends Number & Comparable<T1>, T2 extends Number & Comparable<T2>>
  ...
  protected final void increaseNewListSize() throws IOException {
    ...
    System.arraycopy(tmpNewAdvancedValueSumList, 0, newAdvancedValueSumList, 0,
        tmpOldSize);
    ...
    System.arraycopy(tmpNewAdvancedValueMinList, 0, newAdvancedValueMinList, 0,
        tmpOldSize);
    System.arraycopy(tmpNewAdvancedValueMaxList, 0, newAdvancedValueMaxList, 0,
        tmpOldSize);

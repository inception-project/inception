...
public class MtasDataDoubleFull
    extends MtasDataFull<Double, Double>
{
     ...
     */
    public MtasDataDoubleFull(String collectorType, SortedSet<String> statsItems, String sortType,
    ...
    protected MtasDataItemDoubleFull getItem(int i)
    {
        ...
        if (i >= 0 && i < size) {
            primitiveList = Arrays.stream(fullValueList[i]).mapToDouble(Double::doubleValue)
                    .toArray();
            return new MtasDataItemDoubleFull(primitiveList,

...
public class MtasDataDoubleBasic
    extends MtasDataBasic<Double, Double>
{
     ...
     */
    public MtasDataDoubleBasic(String collectorType, SortedSet<String> statsItems, String sortType,
        ...
        throws IOException
    {
        super(collectorType, CodecUtil.DATA_TYPE_DOUBLE, statsItems, sortType, sortDirection, start,
                number, subCollectorTypes, subDataTypes, subStatsTypes, subStatsItems, subSortTypes,
                subSortDirections, subStart, subNumber, new MtasDataDoubleOperations(),
    ...
    {
        if (i >= 0 && i < size) {
            return new MtasDataItemDoubleBasic(basicValueSumList[i], basicValueNList[i],
    ...
    public MtasDataCollector<?, ?> add(long valueSum, long valueN) throws IOException
    {
        ...
        setValue(newCurrentPosition, Double.valueOf(valueSum), valueN, newCurrentExisting);
     ...
     */
    @Override
    protected boolean compareWithBoundary(Double value, Double boundary) throws IOException
    {
     ...
     */
    @Override
    protected Double lastForComputingSegment(Double value, Double boundary) throws IOException
    {
        if (segmentRegistration.equals(SEGMENT_SORT_ASC)) {
     ...
     */
    @Override
    protected Double boundaryForSegmentComputing(String segmentName) throws IOException
    {
        if (segmentRegistration.equals(SEGMENT_SORT_ASC)
                ...
                if (segmentRegistration.equals(SEGMENT_SORT_DESC)) {
                    ...
                    for (String otherSegmentName : segmentValueTopListLast.keySet()) {
                        if (!otherSegmentName.equals(segmentName)) {
                            Double otherBoundary = segmentValuesBoundary.get(otherSegmentName);
     ...
     */
    @Override
    protected Double stringToBoundary(String boundary, Integer segmentNumber) throws IOException
    {

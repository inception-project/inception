 ...
 */
public class MtasSpanWithinQuery
    extends MtasSpanQuery
{
     ...
     * @param rightMaximum
     *            the right maximum
     * @param adjustBigQuery
     *            the adjust big query
     */
    public MtasSpanWithinQuery(MtasSpanQuery q1, MtasSpanQuery q2, int leftMinimum, int leftMaximum,
            int rightMinimum, int rightMaximum, boolean adjustBigQuery)
    {
        super(null, null);
        bigQuery = q1;
        smallQuery = q2;
        ...
        if (smallQuery != null) {
            if (smallQuery.getMaximumWidth() != null
                    && (maximumWidth == null || smallQuery.getMaximumWidth() < maximumWidth)) {
        ...
        if (field != null) {
            baseQuery = new SpanWithinQuery(new MtasMaximumExpandSpanQuery(bigQuery,
                    ...
                    rightBoundaryBigMaximum), smallQuery);
        }
        else {
            baseQuery = null;
        }
    ...
    public MtasSpanQuery rewrite(IndexReader reader) throws IOException
    {
        ...
        if (newSmallQuery.getMinimumWidth() != null && newBigQuery.getMaximumWidth() != null
                ...
                if (sequenceQuery.getIgnoreQuery() == null) {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (i == 0) {
                            ...
                            else if (items.get(i).getQuery() instanceof MtasSpanRecurrenceQuery) {
                    ...
                    if (newItems.isEmpty()) {
                        ...
                        leftBoundaryBigMinimum = 0;
                        newItems.add(
                                new MtasSpanSequenceItem(new MtasSpanMatchAllQuery(field), false));
                    }
    ...
    public String toString(String field)
    {
        ...
        buffer.append("],[" + leftBoundaryBigMinimum + "," + leftBoundaryBigMaximum + "],["
                + rightBoundaryBigMinimum + "," + rightBoundaryBigMaximum + "])");
    ...
    public int hashCode()
    {
        return Objects.hash(this.getClass().getSimpleName(), smallQuery, bigQuery,
                leftBoundaryBigMinimum, leftBoundaryBigMaximum, rightBoundaryBigMinimum,
                rightBoundaryBigMaximum, autoAdjustBigQuery);
    }

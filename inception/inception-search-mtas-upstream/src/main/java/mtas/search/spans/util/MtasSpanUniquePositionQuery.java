 ...
 */
public class MtasSpanUniquePositionQuery
    extends MtasSpanQuery
{
     ...
     */
    public class SpanUniquePositionWeight
        extends MtasSpanWeight
    {
         ...
         */
        public SpanUniquePositionWeight(SpanWeight subWeight, IndexSearcher searcher,
            ...
            throws IOException
        {
            ...
            if (subSpan == null) {
                ...
                return new MtasSpanUniquePositionSpans(MtasSpanUniquePositionQuery.this, subSpan);
            }
        }

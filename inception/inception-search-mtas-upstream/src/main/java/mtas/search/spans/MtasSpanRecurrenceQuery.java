 ...
 */
public class MtasSpanRecurrenceQuery
    extends MtasSpanQuery
{
    ...
    public MtasSpanRecurrenceQuery(MtasSpanQuery query, int minimumRecurrence,
            int maximumRecurrence, MtasSpanQuery ignoreQuery, Integer maximumIgnoreLength)
    {
        super(null, null);
    ...
    public void setRecurrence(int minimumRecurrence, int maximumRecurrence)
    {
        if (minimumRecurrence > maximumRecurrence) {
            throw new IllegalArgumentException("minimumRecurrence > maximumRecurrence");
        }
    ...
    public int hashCode()
    {
        return Objects.hash(this.getClass().getSimpleName(), query, minimumRecurrence,
                maximumRecurrence);
    }
        ...
        throws IOException
    {
        ...
        return new SpanRecurrenceWeight(subWeight, ignoreWeight, maximumIgnoreLength, searcher,
     ...
     */
    protected class SpanRecurrenceWeight
        extends MtasSpanWeight
    {
        ...
        public SpanRecurrenceWeight(SpanWeight subWeight, SpanWeight ignoreWeight,
                Integer maximumIgnoreLength, IndexSearcher searcher, Map<Term, TermStates> terms,
                float boost)
            throws IOException
        {
            ...
            throws IOException
        {
            if (field == null) {
                ...
                if (subSpans == null) {
                    ...
                    return new MtasSpanRecurrenceSpans(MtasSpanRecurrenceQuery.this, subSpans,
                            minimumRecurrence, maximumRecurrence, ignoreSpans, maximumIgnoreLength);
                }
            }
        }
        ...
        // return subWeight.isCacheable(arg0) && (ignoreWeight==null ||
        // ignoreWeight.isCacheable(arg0));
        // }

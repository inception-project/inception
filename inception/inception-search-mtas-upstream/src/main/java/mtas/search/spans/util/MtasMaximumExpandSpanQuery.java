 ...
 */
public class MtasMaximumExpandSpanQuery
    extends MtasSpanQuery
{
     ...
     *            the maximum right
     */
    public MtasMaximumExpandSpanQuery(MtasSpanQuery query, int minimumLeft, int maximumLeft,
        ...
        throws IOException
    {
        ...
        if (maximumLeft == 0 && maximumRight == 0) {
            ...
            return new MtasMaximumExpandWeight(subWeight, searcher, scoreMode, boost);
        }
    }
    ...
    public MtasSpanQuery rewrite(IndexReader reader) throws IOException
    {
        ...
        if (maximumLeft == 0 && maximumRight == 0) {
            ...
            return new MtasMaximumExpandSpanQuery(newQuery, minimumLeft, maximumLeft, minimumRight,
                    maximumRight);
        }
        else {
     ...
     */
    private class MtasMaximumExpandWeight

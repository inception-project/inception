 ...
 */
public class MtasSpanFullyAlignedWithSpans
    extends MtasSpans
{
    ...
    public MtasSpanFullyAlignedWithSpans(MtasSpanFullyAlignedWithQuery query,
            MtasSpanFullyAlignedWithQuerySpans spans1, MtasSpanFullyAlignedWithQuerySpans spans2)
    {
        super();
        docId = -1;
        this.query = query;
    ...
    private boolean goToNextStartPosition() throws IOException
    {
        ...
        while ((nextSpans1StartPosition = spans1.spans.nextStartPosition()) != NO_MORE_POSITIONS) {
            ...
            if (noMorePositionsSpan2 && nextSpans1StartPosition > lastSpans2StartPosition) {

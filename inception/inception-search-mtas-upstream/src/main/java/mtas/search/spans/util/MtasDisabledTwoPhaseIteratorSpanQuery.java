 ...
 */
public class MtasDisabledTwoPhaseIteratorSpanQuery
    extends MtasSpanQuery
{
        ...
        throws IOException
    {
        ...
        return new MtasDisabledTwoPhaseIteratorWeight(subWeight, searcher, scoreMode, boost);
    }
     ...
     */
    private class MtasDisabledTwoPhaseIteratorWeight
        extends MtasSpanWeight
    {
         ...
         */
        public MtasDisabledTwoPhaseIteratorWeight(SpanWeight subWeight, IndexSearcher searcher,
                ScoreMode scoreMode, float boost)
            throws IOException
        {
            super(subQuery, searcher, scoreMode.needsScores() ? getTermStates(subWeight) : null,
                    boost);
        ...
        public MtasSpans getSpans(LeafReaderContext ctx, Postings requiredPostings)
            throws IOException
        {
            return new MtasDisabledTwoPhaseIteratorSpans(subWeight.getSpans(ctx, requiredPostings));
        }

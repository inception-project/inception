 ...
 */
public class MtasSpanFollowedByQuery
    extends MtasSpanQuery
{
     ...
     */
    protected Map<Term, TermStates> getTermStates(List<MtasSpanFollowedByQueryWeight> items)
    {
    ...
    public MtasSpanQuery rewrite(IndexSearcher searcher) throws IOException
    {
        ...
        if (newQ1 == null || newQ1 instanceof MtasSpanMatchNoneQuery || newQ2 == null
            ...
            return new MtasSpanFollowedByQuery(newQ1, newQ2).rewrite(searcher);
        }
        else {
     ...
     */
    protected class SpanFollowedByWeight
    ...
    protected static class MtasSpanFollowedByQuerySpans
    {
         ...
         *            the spans
         */
        public MtasSpanFollowedByQuerySpans(MtasSpanFollowedByQuery query, Spans spans)
        {

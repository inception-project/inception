 ...
 */
public class MtasSpanPositionQuery
    extends MtasSpanQuery
{
     ...
     */
    protected class SpanPositionWeight
        extends MtasSpanWeight
    {
         ...
         */
        public SpanPositionWeight(IndexSearcher searcher, Map<Term, TermStates> termContexts,
                float boost)
            throws IOException
        {
            ...
            throws IOException
        {
            try {
                ...
                if (t == null) {
                    ...
                    return new MtasSpanPositionSpans(MtasSpanPositionQuery.this, mtasCodecInfo,
                            field, start, end);
                }
            }

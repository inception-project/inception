 ...
 */
public class MtasSpanIntersectingQuery
    extends MtasSpanQuery
{
     ...
     */
    protected Map<Term, TermStates> getTermStates(List<MtasSpanIntersectingQueryWeight> items)
    {
     ...
     */
    protected class SpanIntersectingWeight
        extends MtasSpanWeight
    {
            ...
            throws IOException
        {
            ...
            return new MtasSpanIntersectingSpans(MtasSpanIntersectingQuery.this, s1, s2);
        }
    ...
    protected static class MtasSpanIntersectingQuerySpans
    {
         ...
         *            the spans
         */
        public MtasSpanIntersectingQuerySpans(MtasSpanIntersectingQuery query, Spans spans)
        {

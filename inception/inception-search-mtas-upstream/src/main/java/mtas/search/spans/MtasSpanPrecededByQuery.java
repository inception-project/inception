 ...
 */
public class MtasSpanPrecededByQuery
    extends MtasSpanQuery
{
     ...
     */
    protected Map<Term, TermStates> getTermStates(List<MtasSpanPrecededByQueryWeight> items)
    {
    ...
    public MtasSpanQuery rewrite(IndexSearcher searcher) throws IOException
    {
        ...
        if (newQ1 == null || newQ1 instanceof MtasSpanMatchNoneQuery || newQ2 == null
            ...
            return new MtasSpanPrecededByQuery(newQ1, newQ2).rewrite(searcher);
        }
        else {
     ...
     */
    protected class SpanPrecededByWeight

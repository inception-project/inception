 ...
 */
public class MtasSpanOperatorQuery
    extends MtasSpanQuery
{
     ...
     *            the single position
     */
    public MtasSpanOperatorQuery(String field, String prefix, String operator, String value,
            boolean singlePosition)
    {
        super(singlePosition ? 1 : null, singlePosition ? 1 : null);
        this.field = field;
        ...
        if (q instanceof SpanOrQuery) {
            ...
            for (int i = 0; i < clauses.length; i++) {
                if (clauses[i] instanceof SpanTermQuery) {
                    newClauses[i] = new MtasSpanTermQuery((SpanTermQuery) clauses[i], true)
                            .rewrite(reader);
                }
                else {
    ...
    public boolean equals(Object obj)
    {
        ...
        return singlePosition == other.singlePosition && field.equals(other.field)
                && operator.equals(other.operator) && prefix.equals(other.prefix)
    ...
    public int hashCode()
    {
        return Objects.hash(this.getClass().getSimpleName(), field, prefix, operator, ivalue,
                svalue);
    }
    ...
    public String toString(String field)
    {
        ...
        buffer.append(this.getClass().getSimpleName() + "([" + this.query.getField() + ":" + prefix
                + operator + svalue + "])");

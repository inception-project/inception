    ...
    extends MtasSpans
{
     ...
     *            the sub spans
     */
    public MtasExpandSpans(MtasExpandSpanQuery query, CodecInfo mtasCodecInfo, String field,
            Spans subSpans)
    {
        super();
    ...
    private boolean goToNextStartPosition() throws IOException
    {
        ...
        if (docId == -1 || docId == NO_MORE_DOCS) {
            ...
            if (lastCollectedStartPosition < NO_MORE_POSITIONS
                    && (collectedPositions.isEmpty() || (collectedPositions
                ...
                while ((lastCollectedStartPosition = subSpans
                    ...
                    basicStartPositionMax = lastCollectedStartPosition - query.minimumLeft;

...
import org.dkpro.statistics.agreement.coding.GwetAC1Agreement;
...
public class GwetAC1AgreementMeasure
    extends CodingAgreementMeasure_ImplBase<DefaultAgreementTraits>
{
    ...
    public GwetAC1AgreementMeasure(AnnotationFeature aFeature, DefaultAgreementTraits aTraits,
    ...
    public FullCodingAgreementResult getAgreement(Map<String, CAS> aCasMap)
    {
        ...
        if (agreementResult.isEmpty()) {
            ...
            try {
                var measure = new GwetAC1Agreement(agreementResult.getStudy());

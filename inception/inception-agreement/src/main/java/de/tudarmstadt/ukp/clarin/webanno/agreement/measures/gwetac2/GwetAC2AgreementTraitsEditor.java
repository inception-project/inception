...
public class GwetAC2AgreementTraitsEditor
    extends DefaultAgreementTraitsEditor<DefaultAgreementTraits>
{
    private static final long serialVersionUID = -3229953295561693043L;

    public GwetAC2AgreementTraitsEditor(String aId, IModel<AnnotationFeature> aFeature,

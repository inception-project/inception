...
public class GwetAC1AgreementMeasureTest
    extends AgreementMeasureTestSuite_ImplBase
{
    ...
    public void setup()
    {
        ...
        sut = new GwetAC1AgreementMeasureSupport(annotationService, diffAdapterRegistry);
    ...
    public void twoWithoutLabelTest() throws Exception
    {
        ...
        // A_o = 0.5, categories q=3 with pooled p("")=0.5, p(A)=p(B)=0.25.
        // A_e = (1/(q-1)) * sum p_k(1-p_k) = 0.625/2 = 0.3125.
        // AC1 = (0.5 - 0.3125) / (1 - 0.3125) = 0.2727...

 ...
 * {@link ExternalEditorAutoConfiguration#xHtmlXmlDocumentIFrameViewFactory}.
 * </p>
 */
public class XHtmlXmlDocumentIFrameViewFactory
    implements DocumentViewFactory
{
    public static final String ID = "iframe:cas+xhtml+xml";

...
describe("SpeechManager", () => {
  it("does not drop trailing text after refs in streamed chunks", async () => {
    ...
    sm.speak({ ...(base as MTextMessage), content: "Because he wanted his claim to echo across the galaxy—even past the Shards of the Throne and the ancient “Imperial Throne” variant!", done: false });

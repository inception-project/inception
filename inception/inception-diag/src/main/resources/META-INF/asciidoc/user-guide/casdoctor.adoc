...
This repair clamps annotations that are longer than the document text.
Annotations that are entire after end of the document text are collapsed into a zero-width

...
// editors/basic/visualization/AnnotationExperienceAPIBasicEditorVisualization.ts
...
var SaveWordAlignmentRequest = class {
  constructor(aClientName, aUserName, aProjectId, aDocumentId, aSentence, aAlignments) {
    this.clientName = aClientName;
    this.userName = aUserName;
    this.projectId = aProjectId;
    this.documentId = aDocumentId;
...
var AnnotationExperienceAPIImpl = class {
  ...
  requestSaveWordAlignment(aClientName, aUserName, aProjectId, aDocumentId, aSentence, aAlignments) {
    this.stompClient.publish({
      destination: "/app/update_word_alignment_from_client",
      body: JSON.stringify(new SaveWordAlignmentRequest(aClientName, aUserName, aProjectId, aDocumentId, aSentence, aAlignments))
    });
  }
...
// editors/basic/action/AnnotationExperienceAPIBasicEditorActionHandler.ts
...
// editors/basic/AnnotationExperienceAPIBasicEditor.ts
var AnnotationExperienceAPIBasicEditor = class {
  constructor() {
    this.annotationExperienceAPI = new AnnotationExperienceAPIImpl();
    this.annotationExperienceAPIVisualization = new AnnotationExperienceAPIBasicEditorVisualization(this.annotationExperienceAPI);
    this.annotationExperienceAPIActionHandler = new AnnotationExperienceAPIBasicEditorActionHandler(this.annotationExperienceAPI);
  }
};

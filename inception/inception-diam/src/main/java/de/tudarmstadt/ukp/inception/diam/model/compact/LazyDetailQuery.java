...
public class LazyDetailQuery
{
    ...
    public LazyDetailQuery(VID aTarget, String aReftext)
    {
        this(aTarget, "", "", aReftext);
    }

    public LazyDetailQuery(VID aTarget, String aRefDb, String aRefId)
    {
        this(aTarget, aRefDb, defaultIfEmpty(aRefId, null), null);
    }

    public LazyDetailQuery(VID aTarget, String aRefDb, String aRefId, String aReftext)
    {
        target = aTarget;
        refText = aReftext;
        refDb = aRefDb;

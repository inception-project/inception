...
/**
 * Class required for Messaging between Server and Client. Basis for JSON DeleteAnnotationRequest:
 * Request from Client to delete a certain annotation
 *
 ...
 * of the sourcedocument the annotation belongs to annotationId: The ID of the annotation to delete

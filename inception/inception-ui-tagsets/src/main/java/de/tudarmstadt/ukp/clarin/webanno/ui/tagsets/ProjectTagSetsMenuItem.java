...
@Component
@Order(TagsetsProjectSettingsPanelFactory.ORDER)
public class ProjectTagSetsMenuItem
    extends ProjectSettingsMenuItemBase
{
    @Override
    public String getPath()
    {
        return "/settings/tagsets";
    }
    ...
    public String getLabel()
    {
        ...
        return new ProjectTagSetsPage(currentPage.getPageParameters())
                .getString("projecttagsets.menuitem.label");
    ...
    {
        return ProjectTagSetsPage.class;
    }
}

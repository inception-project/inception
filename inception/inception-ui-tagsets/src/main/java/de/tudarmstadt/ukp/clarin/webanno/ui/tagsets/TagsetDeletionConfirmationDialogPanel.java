...
public class TagsetDeletionConfirmationDialogPanel
    extends ConfirmationDialogContentPanel_ImplBase
{
    private static final long serialVersionUID = 7050666954726883326L;

    public TagsetDeletionConfirmationDialogPanel(String aId, IModel<TagSet> aModel)
    {
        super(aId);
        queue(new Label("name", aModel.map(TagSet::getName)));
    }
}

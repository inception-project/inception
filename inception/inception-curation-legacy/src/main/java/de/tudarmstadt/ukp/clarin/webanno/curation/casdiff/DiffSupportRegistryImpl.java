...
public class DiffSupportRegistryImpl
    extends ExtensionPoint_ImplBase<AnnotationLayer, DiffSupport>
    implements DiffSupportRegistry
{
    public DiffSupportRegistryImpl(@Lazy @Autowired(required = false) List<DiffSupport> aExtensions)
    {
        super(aExtensions);
    }
}

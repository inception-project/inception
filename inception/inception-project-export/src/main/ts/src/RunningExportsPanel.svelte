...
<div class="flex-content flex-v-container">
    ...
    {#if connected && !exports?.length}
        <div class="flex-content flex-h-container no-data-notice">No exports.</div>
    {/if}
    {#if exports?.length}
                        ...
                        <div class="card">
                            <div class="card-header small">
                                ...
                                <button
                                    ...
                                    aria-label="Close"
                                    onclick={closeMessages(item)}
                                ></button>
                            </div>
                            <div
                                class="card-body"
                                style="max-height: 10em; min-height: 3em; overflow: auto;"
                            >
                                    ...
                                    <div>
                                        <small>
                                            ...
                                            {:else if message.level === 'WARN'}
                                                <i class="text-warning fas fa-exclamation-triangle"
                                                ></i>
                                            {:else}
                            ...
                            <small>
                                ...
                                {#if item.messageCount > 1 && item.state !== 'RUNNING'}
                                    <span
                                        ...
                                        class="float-end badge rounded-pill bg-light text-dark"

...
public class BooleanFeatureTraitsEditor
    extends GenericPanel<AnnotationFeature>
{
    ...
    private CompoundPropertyModel<BooleanFeatureTraits> traits;

    public BooleanFeatureTraitsEditor(String aId,
            UimaPrimitiveFeatureSupport_ImplBase<BooleanFeatureTraits> aFS,
            IModel<AnnotationFeature> aFeature)
    {
        ...
        var form = new Form<BooleanFeatureTraits>(MID_FORM, traits)
        {
        ...
        var defaultValue = new DropDownChoice<>("defaultValue", asList(false, true));
        form.add(defaultValue);
    }

    @SuppressWarnings("unchecked")
    private UimaPrimitiveFeatureSupport_ImplBase<BooleanFeatureTraits> getFeatureSupport()
    {
        return (UimaPrimitiveFeatureSupport_ImplBase<BooleanFeatureTraits>) featureSupportRegistry

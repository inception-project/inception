    ...
    extends AeroController_ImplBase
{
            ...
            Recommender recommender)
    {
        if (!recommender.isEnabled()) {
            new IllegalArgumentException("Recommender [" + aRequest.recommender() + "] in project ["
                    + aProjectId + "] is not enabled.");
        }
        ...
        if (engine.getTrainingCapability() == TRAINING_REQUIRED) {
            ...
            new IllegalArgumentException("Recommender [" + aRequest.recommender()
            ...
            RBulkPredictionRequest aRequest, Project project)
    {
        ...
        if (aRequest.metadata() != null) {
            for (var layerEntry : aRequest.metadata().entrySet()) {

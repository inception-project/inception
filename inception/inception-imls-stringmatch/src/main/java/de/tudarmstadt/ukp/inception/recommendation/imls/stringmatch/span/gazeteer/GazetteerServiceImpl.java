    ...
    implements GazetteerService
{
    ...
    @Override
    @Transactional
    public void createOrUpdateGazetteer(Gazetteer aGazeteer)
    {
    ...
    @Override
    @Transactional
    public void importGazetteerFile(Gazetteer aGazeteer, InputStream aStream) throws IOException
    {
        var gazFile = getGazetteerFile(aGazeteer);
    ...
    @Override
    public File getGazetteerFile(Gazetteer aGazeteer) throws IOException
    {
    ...
    @Override
    @Transactional
    public void deleteGazetteers(Gazetteer aGazeteer) throws IOException
    {
        try (var logCtx = withProjectLogger(aGazeteer.getRecommender().getProject())) {
            ...
            var gaz = getGazetteerFile(aGazeteer);
            if (gaz.exists()) {
                gaz.delete();
            }

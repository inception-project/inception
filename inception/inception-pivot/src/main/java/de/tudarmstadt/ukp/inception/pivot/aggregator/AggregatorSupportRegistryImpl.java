...
public class AggregatorSupportRegistryImpl
    extends ExtensionPoint_ImplBase<List<Extractor>, AggregatorSupport>
    implements AggregatorSupportRegistry
{

    public AggregatorSupportRegistryImpl(

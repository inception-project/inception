...
public class MenuBarItemRegistryImpl
    extends ExtensionPoint_ImplBase<Page, MenuBarItem>
    implements MenuBarItemRegistry
{
    public MenuBarItemRegistryImpl(@Lazy @Autowired(required = false) List<MenuBarItem> aExtensions)
    {
        super(aExtensions);
    }
}

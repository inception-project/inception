 ...
 */
package de.tudarmstadt.ukp.inception.wordalignment.config;
...
import de.tudarmstadt.ukp.inception.wordalignment.WordAlignmentEditor;
    ...
    extends AnnotationEditorFactoryImplBase
{
    ...
    {
        return new WordAlignmentEditor(aId, aModel, aActionHandler, aCasProvider);
    }
}

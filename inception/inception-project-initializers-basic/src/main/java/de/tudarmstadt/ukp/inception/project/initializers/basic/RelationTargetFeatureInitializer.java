 ...
 * {@link InceptionBasicProjectInitializersAutoConfiguration#relationTargetFeatureInitializer}.
 * </p>
 */
@Order(10)
public class RelationTargetFeatureInitializer
    implements FeatureInitializer
{
    ...
    @Autowired
    public RelationTargetFeatureInitializer(AnnotationSchemaService aAnnotationSchemaService)
    {
    ...
    {
        return "Relation target feature";
    }

    @Override
    public Optional<String> getDescription()
    {
        return Optional.of(Strings.getString("target-feature.description"));
    }
    ...
    public boolean alreadyApplied(AnnotationLayer aLayer)
    {
        ...
        return annotationSchemaService.existsFeature(FEAT_REL_TARGET, aLayer);
    }
    ...
    public void configure(AnnotationLayer aLayer) throws IOException
    {
        ...
        var sourceFeature = AnnotationFeature.builder() //
                .withLayer(aLayer) //
                .withType(PREFIX_TARGET + attachTypeName) //

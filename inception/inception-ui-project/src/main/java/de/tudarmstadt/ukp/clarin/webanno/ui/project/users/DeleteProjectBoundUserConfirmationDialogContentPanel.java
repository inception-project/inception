...
public class DeleteProjectBoundUserConfirmationDialogContentPanel
    extends ChallengeResponseDialogContentPanel_ImplBase
{
    private static final long serialVersionUID = -943392917974988048L;

    public DeleteProjectBoundUserConfirmationDialogContentPanel(String aId, IModel<User> aIModel)
    {

...
public class FeatureTemplateSelectedEvent
    extends AbstractAjaxAwareEvent
{
    private final FeatureInitializer featureInitializer;

    public FeatureTemplateSelectedEvent(AjaxRequestTarget aTarget,
            FeatureInitializer aFeatureInitializer)
    {
        super(aTarget);
    ...
    public FeatureInitializer getLayerInitializer()
    {

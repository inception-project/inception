    ...
    extends AbstractTraitsEditor
{
    ...
    public OllamaInteractionPanel(String aId, IModel<Recommender> aRecommender,
            IModel<List<Preset>> aPresets)
    {
        ...
        var responseFormat = new ResponseFormatSelect(MID_FORMAT);
    ...
    private void actionExtractionModeChanged(MarkdownLabel markdownLabel,
            ResponseFormatSelect responseFormat, AjaxRequestTarget _target)
    {

...
public class DeleteKnowledgeBaseConfirmationDialogPanel
    extends ConfirmationDialogContentPanel_ImplBase
{
    private static final long serialVersionUID = 7050666954726883326L;

    public DeleteKnowledgeBaseConfirmationDialogPanel(String aId, IModel<KnowledgeBase> aModel)
    {
        super(aId);
        queue(new Label("name", aModel.map(KnowledgeBase::getName)));
    }
}

...
include::{include-dir}settings_keybindings.adoc[leveloffset=+1]
...
include::{include-dir}settings_curation.adoc[leveloffset=+1]
...
include::{include-dir}settings_reference_document.adoc[leveloffset=+1]

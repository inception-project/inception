...
include::{include-dir}settings_annotation-editor_pdf.adoc[leveloffset=+1]

include::{include-dir}settings_annotation-editor_pdf_legacy.adoc[leveloffset=+1]

include::{include-dir}security-policy.adoc[leveloffset=+1]

include::{include-dir}security-oauth2.adoc[leveloffset=+1]
...
include::{include-dir}settings_segmentation.adoc[leveloffset=+1]

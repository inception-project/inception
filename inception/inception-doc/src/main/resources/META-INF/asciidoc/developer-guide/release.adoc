...
If you have just made a release, change to `target/checkout/inception-dist-docker`. Otherwise check out the release
...
Then go to the `inception-dist-docker` module folder and there run the following commands:

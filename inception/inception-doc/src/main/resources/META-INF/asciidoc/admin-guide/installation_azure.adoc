...
Use <<sect_security_authentication_oauth2,OAuth2/OIDC>> to connect {product-name} to Entra ID.

If you really must use SAML instead, check the trouble shooting section in our <<sect_security_authentication_saml2,SAML2>> setup documentation.

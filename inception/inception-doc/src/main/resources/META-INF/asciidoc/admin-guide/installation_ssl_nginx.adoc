...
What seems to work in this case is to turn add the following lines to your `settings.properties` file (see <<admin-guide.adoc#sect_settings>>, replace the server name and URL with your own):

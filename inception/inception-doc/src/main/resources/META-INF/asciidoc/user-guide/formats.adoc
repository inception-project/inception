...
| <<sect_formats_uimajson,UIMA CAS JSON 0.4.0>>
| `jsoncas`
| `format.json-cas.enabled`

| <<sect_formats_uimajson,UIMA CAS JSON 0.4.0 (XML/PDF structure)>>
| `jsoncas-struct`
| `format.json-cas-struct.enabled`
...
| <<sect_formats_uimaxmi,UIMA XMI CAS (XML 1.0 + PDF/XML structure)>>
| `xmi-struct`
| `format.uima-xmi-struct.enabled`

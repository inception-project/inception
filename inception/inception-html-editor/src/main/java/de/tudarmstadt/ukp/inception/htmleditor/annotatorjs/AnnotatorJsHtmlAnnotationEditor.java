    ...
    extends ExternalAnnotationEditorBase
{
    ...
    private @SpringBean(name = "htmlDocumentViewFactory") DocumentViewFactory viewFactory;
    ...
    // .forScript(WicketUtil.wrapInTryCatch(initAnnotatorJs(getViewComponent(), storeAdapter))));
    // }
    // }
    ...
    // "Wicket.$('" + getViewComponent().getMarkupId() + "').temp = " + json + ";");
    // }
    // }
}

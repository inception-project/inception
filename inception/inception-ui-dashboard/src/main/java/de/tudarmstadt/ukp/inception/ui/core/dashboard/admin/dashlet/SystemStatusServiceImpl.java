...
{
    private final CsrfAttacksPreventionProperties csrfAttacksPreventionProperties;

    public SystemStatusServiceImpl(CsrfAttacksPreventionProperties aCsrfAttacksPreventionProperties)
    {
        csrfAttacksPreventionProperties = aCsrfAttacksPreventionProperties;
    }

    @Override
    public CsrfAttacksPreventionProperties getCsrfAttacksPreventionProperties()
    {
        return csrfAttacksPreventionProperties;
    }
}

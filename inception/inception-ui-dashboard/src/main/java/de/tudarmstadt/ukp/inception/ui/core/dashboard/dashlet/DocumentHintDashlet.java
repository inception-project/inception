...
public class DocumentHintDashlet
    extends Dashlet_ImplBase
{
    ...
    public DocumentHintDashlet(String aId, IModel<Project> aProject)
    {
        super(aId, aProject);

        add(new BookmarkablePageLink<Void>("jumpToDocuments", ProjectDocumentsPage.class,

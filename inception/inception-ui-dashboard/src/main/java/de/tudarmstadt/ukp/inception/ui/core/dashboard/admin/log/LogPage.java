 ...
 */
package de.tudarmstadt.ukp.inception.ui.core.dashboard.admin.log;
    ...
    extends AdminSettingsDashboardPageBase
{
    ...
    public LogPage(final PageParameters aParameters)
    {
        super(aParameters);
        ...
        autoRefresh = new CheckBox("autoRefresh", Model.of(false));

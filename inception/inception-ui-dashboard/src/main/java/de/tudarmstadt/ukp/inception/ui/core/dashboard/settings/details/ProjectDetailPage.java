...
@MountPath(NS_PROJECT + "/${" + PAGE_PARAM_PROJECT + "}/settings/details")
    ...
    extends ProjectSettingsDashboardPageBase
{
    ...
    public ProjectDetailPage(PageParameters aParameters)
    {
        super(aParameters);
    }
    ...
    protected void onInitialize()
    {
        ...
        add(new ProjectDetailPanel("panel", getProjectModel()));
    }
}

...
@Configuration
public class LlmChatClientAutoConfiguration
{
    @Bean
    public LlmChatClientExtensionPoint llmChatClientExtensionPoint(
            @Lazy @Autowired(required = false) List<LlmChatClient> aClients)
    {
        return new LlmChatClientExtensionPointImpl(aClients);
    }
}

...
public class ToolLibraryExtensionPointImpl
    extends ExtensionPoint_ImplBase<Project, ToolLibrary>
    implements ToolLibraryExtensionPoint
{
    public ToolLibraryExtensionPointImpl(

...
@Configuration
public class PubMedServicesAutoConfiguration
{
    @Bean
    public EntrezClient entrezClient()
    {
        return new EntrezClient();
    }

    @Bean
    public PmcOaClient pmcOaClient()
    {
        return new PmcOaClient();
    }
}

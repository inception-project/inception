...
public class ProjectWorkloadMenuItem
    extends ProjectSettingsMenuItemBase
{
    ...
    public String getLabel()
    {
        ...
        return new ProjectWorkloadPage(currentPage.getPageParameters())
                .getString("projectworkload.menuitem.label");

         // return new StringResourceModel("projectworkload.menuitem.label").getString();
    }

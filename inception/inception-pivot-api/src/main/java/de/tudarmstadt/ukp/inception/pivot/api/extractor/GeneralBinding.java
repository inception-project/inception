...
/**
 * Binds a layer-independent ("general") extractor, i.e. one that is not tied to any particular
 * layer or feature.
 */
public record GeneralBinding()
    implements ExtractorBinding
{
    ...
    {
        return new ExtractorDef(aExtractorId, null, null);
    }
}

...
@MountPath(NS_PROJECT + "/${" + PAGE_PARAM_PROJECT + "}/settings/sharing")
public class ProjectSharingPage
    extends ProjectSettingsDashboardPageBase
{
    private static final long serialVersionUID = 5889016668816051716L;

    public ProjectSharingPage(PageParameters aParameters)
    {
        super(aParameters);
    }
    ...
    protected void onInitialize()
    {
        ...
        add(new InviteProjectSettingsPanel("panel", getProjectModel()));
    }
}

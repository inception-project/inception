...
public class BulkProcessorRegistryImpl
    extends ExtensionPoint_ImplBase<Project, BulkProcessor>
    implements BulkProcessorRegistry
{
    public BulkProcessorRegistryImpl(

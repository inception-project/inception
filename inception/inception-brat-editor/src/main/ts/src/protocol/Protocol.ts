...
export type AnnotationCommentDto = [id: VID, commentType: CommentType, comment: string];
...
export type AnnotationMarkerDto = [id: VID, type: MarkerType];

export type SentenceMarkerDto = [kind: 'sent', type: MarkerType, index: number];

export type TextMarkerDto = [begin: number, end: number];
 ...
 * @see
 */
export type RoleDto = [type: number, target: VID];
 ...
 */
export type AttributeDto = [id: string, name: string, spanId: VID, value: string];

/**
 * @deprecated Not used by server side
 */
export type EquivDto = [a: string, b: 'Equiv', ...spanId: Array<string>];

/**
 * @deprecated Not used by server side
 */
export type EventDto = [id: string, triggerId: string, roles: Array<RoleDto>];

/**
 * @deprecated Not used by server side
 */
export type TriggerDto = [id: string, type: string, offsets: Array<Offsets>];

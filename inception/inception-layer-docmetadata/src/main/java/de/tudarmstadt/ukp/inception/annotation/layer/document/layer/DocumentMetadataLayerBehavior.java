...
import de.tudarmstadt.ukp.inception.annotation.layer.document.undo.CreateDocumentMetadataAnnotationAction;
    ...
    implements LayerBehavior
{
    ...
    {
        return aLayerType instanceof DocumentMetadataLayerSupport;
    }

    public abstract CreateDocumentMetadataAnnotationAction onCreate(TypeAdapter aAdapter,
            CreateDocumentMetadataAnnotationAction aRequest)

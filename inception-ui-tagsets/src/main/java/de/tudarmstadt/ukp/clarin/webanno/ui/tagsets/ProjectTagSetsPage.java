...
@MountPath(NS_PROJECT + "/${" + PAGE_PARAM_PROJECT + "}/settings/tagsets")
public class ProjectTagSetsPage
    extends ProjectSettingsDashboardPageBase
{
    private static final long serialVersionUID = 5889016668816051716L;

    public ProjectTagSetsPage(PageParameters aParameters)
    {
        super(aParameters);
    }
    ...
    protected void onInitialize()
    {
        ...
        add(new ProjectTagSetsPanel("panel", getProjectModel()));
    }
}

 ...
 * is saved/deleted.
 */
public class AjaxStatementChangedEvent<T extends Serializable> extends AjaxEvent {
     ...
     */
    private KBStatement<T> statement;
    ...
    public AjaxStatementChangedEvent(AjaxRequestTarget target, KBStatement<T> statement) {
    ...
    public KBStatement<T> getStatement() {
        return statement;
    }

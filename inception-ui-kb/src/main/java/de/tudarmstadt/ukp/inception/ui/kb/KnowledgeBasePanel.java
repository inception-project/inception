 ...
 */
public class KnowledgeBasePanel extends EventListeningPanel {
    ...
    public KnowledgeBasePanel(String id, IModel<Project> aProjectModel,
        ...
        ddc.add(new AjaxFormComponentUpdatingBehavior("change") {
            ...
            private static final long serialVersionUID = -9171394493371287684L;
        ...
        add(new ConceptListPanel("concepts", kbModel, selectedConceptHandle));
        add(new PropertyListPanel("properties", kbModel, selectedPropertyHandle));
    ...
    private void actionStatementChanged(AjaxRequestTarget target, AjaxStatementChangedEvent event) {
        ...
        boolean isRenameEvent = statement
                .getProperty()
                .getIdentifier()
        ...
        if (isRenameEvent) {
            ...
            models.stream()
                    .filter(model -> model.getObject() != null && model.getObject()
                            .getIdentifier()
    ...
    private void actionPropertySelectionChanged(AjaxRequestTarget target,
        ...
        if (selectedPropertyHandle.getObject() == null) {
            ...
            KBProperty selectedProperty = kbService.readProperty(kbModel.getObject(),
                    selectedPropertyHandle.getObject().getIdentifier());
            replacementPanel = new PropertyPanel(DETAILS_MARKUP_ID, kbModel,
                    selectedPropertyHandle, Model.of(selectedProperty));
        }
        details = details.replaceWith(replacementPanel);

...
In addition, we provide an explanation for the score through the UIMA feature obtained by calling
`getScoreExplanationFeature` inside a `RecommendationEngine`.

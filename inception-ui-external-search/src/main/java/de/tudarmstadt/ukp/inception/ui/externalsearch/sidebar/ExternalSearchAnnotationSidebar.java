...
import de.tudarmstadt.ukp.inception.ui.externalsearch.ExternalResultDataProvider;
    ...
    extends AnnotationSidebar_ImplBase
{
            ...
            AnnotationPage aAnnotationPage)
    {
        ...
        searchStateModel = new CompoundPropertyModel<>(LambdaModelAdapter.of(
                () -> aAnnotationPage.getMetaData(ExternalSearchUserStateMetaData.CURRENT_ES_USER_STATE),
                searchState -> aAnnotationPage.setMetaData(ExternalSearchUserStateMetaData.CURRENT_ES_USER_STATE, searchState)));

        // Set up the search state in the page if it is not already there
        if (aAnnotationPage.getMetaData(ExternalSearchUserStateMetaData.CURRENT_ES_USER_STATE) == null) {

...
@Component
@ConditionalOnProperty(prefix = "ui.tag", name = "enabled", havingValue = "true", 
        matchIfMissing = false)
public class TagAnnotationEditorFactory
    extends AnnotationEditorFactoryImplBase
{
    @Override
    public String getDisplayName()
    {
        return "TextAnnotationGraph";
    }
    ...
    {
        return new TagAnnotationEditor(aId, aModel, aActionHandler, aJCasProvider);
    }
}

    ...
    implements ClassificationToolFactory<DL4JConfigurationParameters, Void>
{
    ...
    @Override
    public ClassificationTool<DL4JConfigurationParameters> createTool(long aRecommenderId,
        String aFeature, AnnotationLayer aLayer, int aMaxPredictions)
    {
        return new DL4JPosClassificationTool(aRecommenderId, aFeature, aLayer);
    }

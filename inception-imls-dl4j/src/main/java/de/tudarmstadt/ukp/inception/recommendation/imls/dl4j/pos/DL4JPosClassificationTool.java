    ...
    extends ClassificationTool<DL4JConfigurationParameters>
{
    ...
    public DL4JPosClassificationTool(String feature) {
        this(getCache(), feature);
    }
    ...
    public DL4JPosClassificationTool(File aCache, String feature)
    {
        super();
        ...
        setLoader(new PosAnnotationObjectLoader());

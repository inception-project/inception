...
public class VIDTest
{
    ...
    public void test()
    {
        ...
        assertEquals("ext:10-1.2.3@1", new VID("ext", "10-1.2.3@1").toString());
    ...
    public void testParse()
    {
        ...
        assertParseVid("ext", -1, -1,  -1,  -1,  -1, "ext:10-1.2.3", "10-1.2.3");
        assertParseVid("ext",  -1, -1,  -1,  -1,  -1, "ext:10-1.2.3@1", "10-1.2.3@1");
    }

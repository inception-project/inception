...
@Component("constituentEditor")
public class ConstituentAnnotationEditorFactory
    extends AnnotationEditorFactoryImplBase
{
    ...
    {
        return new ConstituentsAnnotationEditor(aId, aModel, aActionHandler, aJCasProvider);
    }
}

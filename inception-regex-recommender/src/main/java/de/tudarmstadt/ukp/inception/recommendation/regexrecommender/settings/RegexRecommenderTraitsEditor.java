package de.tudarmstadt.ukp.inception.recommendation.regexrecommender.settings;
...
public class RegexRecommenderTraitsEditor
    extends DefaultTrainableRecommenderTraitsEditor
{
    private static final Logger LOG = LoggerFactory
            .getLogger(RegexRecommenderTraitsEditor.class);
    ...
    public RegexRecommenderTraitsEditor(String aId, IModel<Recommender> aRecommender)
    {

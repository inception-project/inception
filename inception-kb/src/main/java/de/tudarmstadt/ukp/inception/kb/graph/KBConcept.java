    ...
    implements KBObject
{
    ...
    static {
        ...
        CLOSED = factory.createIRI(KnowledgeBaseService.INCEPTION_NAMESPACE, "closed");
        ABSTRACT = factory.createIRI(KnowledgeBaseService.INCEPTION_NAMESPACE, "abstract");
    }
    ...
    public void write(RepositoryConnection aConn)
    {
        ...
        Statement typeStmt = vf.createStatement(subject, RDF.TYPE, RDFS.CLASS);
        ...
        Statement abstractStmt = vf.createStatement(subject, ABSTRACT,
                vf.createLiteral(abstractClass));

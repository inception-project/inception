...
For tutorials on the different functionalities of {product-name}, please see [https://code.google.com/p/webanno/wiki/Tutorials Tutorials]. 
...
include::{include-dir}inception-upgrade.adoc[]

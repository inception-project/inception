    ...
    extends MtasParser
{
        ...
        throws MtasParserException, MtasConfigException
    {
        ...
        try {
            ...
            List<TypeSystemDescription> projectTypes = annotationSchemaService
            ...
            for (Annotation annotation : JCasUtil.select(jcas, Annotation.class)) {
                ...
                // 2) if hte last token ends before the last char. Same as above.
                ...
                if (tokenEndIndex.ceilingEntry(annotation.getEnd() - 1) == null) {
                 ...
                 // Special case: token value must be indexed
                    ...
                    if (layers.get(annotationName) != null) {
                        ...
                        for (AnnotationFeature feature: layerFeatures.get(annotationName)) {
                            ...
                            if (WebAnnoCasUtil.isPrimitiveFeature(annotation, feature.getName())) {
                                ...
                                featureValue = "" + WebAnnoCasUtil.getFeature(annotation,
                                        feature.getName());
                                
                                // Add the UI feature name to the index as an annotation
                                MtasToken mtasToken = new MtasTokenString(mtasId++,
                                        annotationUiName + "." + feature.getUiName()

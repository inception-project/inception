...
@MountPath(NS_PROJECT + "/${" + PAGE_PARAM_PROJECT + "}/settings/workload")
public class ProjectWorkloadPage
    extends ProjectSettingsDashboardPageBase
{
    private static final long serialVersionUID = 5889016668816051716L;

    public ProjectWorkloadPage(PageParameters aParameters)
    {
        super(aParameters);
    }
    ...
    protected void onInitialize()
    {
        ...
        add(new WorkloadSettingsPanel("panel", getProjectModel()));
    }
}

...
public class StringMatchingNerClassificationToolTest
{
    ...
    @Test
    public void testStringMatchingNerClassifier()
        throws IOException
    {
        System.err.println("\n== Testing StringMatchingNerClassifier");

        ClassifierConfiguration<Object> classifierConf = new ClassifierConfiguration<>();
        classifierConf.setLanguage("de");

        ClassificationTool<Object> ct = new StringMatchingNerClassificationTool();
        ...
        Reporter.dumpResults(
                new File(testConf.getResultFolder(),
                        "StringMatchingNerClassifier" + testTimestamp + ".html"),
                testConf, results);
    }
...
//                Conll2002Reader.PARAM_READ_NAMED_ENTITY, true);
        ...
        return nerLoader.loadAnnotationObjects(reader, "value");
    }
}

...
public class StringMatchingPosClassificationToolTest
{
    ...
    @Test
    public void testStringMatchingPosClassifier()
        throws IOException
    {
        System.err.println("\n== Testing StringMatchingPosClassifier");

        ClassifierConfiguration<Object> classifierConf = new ClassifierConfiguration<>();
        classifierConf.setLanguage("en");

        ClassificationTool<Object> ct = new StringMatchingPosClassificationTool();
        ...
        Reporter.dumpResults(
                new File(testConf.getResultFolder(),
                        "StringMatchingPosClassifier" + testTimestamp + ".html"),
                testConf, results);
    }

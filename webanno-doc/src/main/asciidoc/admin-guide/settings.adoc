...
| _unset_
| <h5> <span style="color:red ; font-size: 200%;"><p>This instance of WebAnno is publicly available and your data are freely visible to the public. The instance is only for demo purposes and projects might be modified or deleted at any time by anyone. We also do not guarantee the availability of  the service 24/7.</p></span></h5>
|===

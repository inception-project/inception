...
| _unset_
| AllAnnotationsIndexedCheck, LinksReachableThroughChainsCheck, FeatureAttachedSpanAnnotationsTruelyAttachedCheck
...
| _unset_
| RemoveDanglingRelationsRepair, RemoveDanglingChainLinksRepair, ReattachFeatureAttachedSpanAnnotationsRepair

...
Moreover, additional custom layers may be created, as described in [http://code.google.com/p/webanno/wiki/Projects#New_Layer_Creation New Layer Creation] in detail.

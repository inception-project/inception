...
| Whether the annotation detail editor should show the feature or not based on constraint rules. If rules evaluate returns in perfect match, it's shown otherwise hidden.

...
annotators across all documents. Possible units for measuring the agreement are link: https://en.wikipedia.org/wiki/Cohen%27s_kappa[Cohen's kappa] as implemented in

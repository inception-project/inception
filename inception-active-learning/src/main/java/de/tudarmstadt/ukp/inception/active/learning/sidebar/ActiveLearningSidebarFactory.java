...
public class ActiveLearningSidebarFactory extends AnnotationSidebarFactory_ImplBase {
    private static final ResourceReference ICON =
        new PackageResourceReference(ActiveLearningSidebarFactory.class, "star.png");
    ...
    public AnnotationSidebar_ImplBase create(String aId, IModel<AnnotatorState> aModel,
                                             AnnotationActionHandler aActionHandler, JCasProvider
                                                     aJCasProvider,
                                             AnnotationPage aAnnotationPage) {
        return new ActiveLearningSidebar(aId, aModel, aActionHandler, aJCasProvider,
                aAnnotationPage);
    }
}

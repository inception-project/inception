 ...
 */
package de.tudarmstadt.ukp.inception.active.learning.model;
...
public class LearningRecord implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (offsetCharacterBegin != that.offsetCharacterBegin) return false;
        if (offsetCharacterEnd != that.offsetCharacterEnd) return false;

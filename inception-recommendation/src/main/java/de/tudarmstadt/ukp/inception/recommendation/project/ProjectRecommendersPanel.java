    ...
    extends ProjectSettingsPanelBase
{
    ...
    public ProjectRecommendersPanel(String aId, IModel<Project> aProject)
    {
        ...
        RecommenderEditorPanel conceptEditorPanel = new RecommenderEditorPanel("recommenderEditor",
                projectModel, selectedRecommenderModel);
        add(conceptEditorPanel);
        
        RecommenderListPanel conceptListPanel = new RecommenderListPanel("recommenders",
                projectModel, selectedRecommenderModel);
        conceptListPanel.setCreateAction(t -> 
                selectedRecommenderModel.setObject(new Recommender()));
        conceptListPanel.setChangeAction(t -> t.add(conceptEditorPanel));

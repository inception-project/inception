...
@MountPath(NS_PROJECT + "/${" + PAGE_PARAM_PROJECT + "}/settings/recommenders")
public class ProjectRecommendersPage
    extends ProjectSettingsDashboardPageBase
{
    private static final long serialVersionUID = 5889016668816051716L;

    public ProjectRecommendersPage(PageParameters aParameters)
    {
        super(aParameters);
    }
    ...
    protected void onInitialize()
    {
        ...
        add(new ProjectRecommendersPanel("panel", getProjectModel()));
    }
}

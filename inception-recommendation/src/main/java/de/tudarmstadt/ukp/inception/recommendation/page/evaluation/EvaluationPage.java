...
@MenuItem(icon = "images/statistics.png", label = "Recommendation Evaluation", prio = 310)
    ...
    extends ApplicationPageBase
{
    ...
    public EvaluationPage()
    {
        ...
        ListChoice<String> feature = new ListChoice<>("feature");
    ...
    private List<String> listClassifiers()
    {
        ...
        ClassificationToolRegistry classificationToolRegistry = new ClassificationToolRegistry();
        List<String> classifierList = classificationToolRegistry
                .getRegisteredClassificationToolIds().get(selectedLayer.getObject().getName());
    ...
    private void evaluate(AjaxRequestTarget aTarget, Form<Preferences> aForm)
    {
        ...
        for (String classifierId : selectedClassifiers.getObject()) {
            ...
            recommender.setFeature(pref.feature);
            ...
            for (SourceDocument doc : selectedDocuments.getObject()) {
                ...
                annotatedData.addAll(loader.loadAnnotationObjects(jCas, ct.getFeature()));
            }            

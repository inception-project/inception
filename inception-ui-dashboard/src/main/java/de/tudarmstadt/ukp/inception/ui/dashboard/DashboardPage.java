            ...
            protected void populateItem(ListItem<MenuItemDecl> aItem)
            {
                ...
                StatelessLink<Void> menulink = new StatelessLink<Void>("menulink") {
                    ...
                    public void onClick()
                    {
                        ...
                        setResponsePage(item.page, params);
                    }
                };
                ...
                boolean isAdminItem = asList("ProjectPage", "ManageUsersPage")
                        .contains(item.page.getSimpleName());
                
                boolean conditionApplies = item.condition == null || item.condition.applies();
                
                aItem.add(menulink);
                aItem.setVisible(conditionApplies && (project != null || isAdminItem));
            }
        };
        add(menu);

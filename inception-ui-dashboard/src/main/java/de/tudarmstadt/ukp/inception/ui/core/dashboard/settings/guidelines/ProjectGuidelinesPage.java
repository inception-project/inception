 ...
 */
package de.tudarmstadt.ukp.inception.ui.core.dashboard.settings.guidelines;
...
@MountPath(NS_PROJECT + "/${" + PAGE_PARAM_PROJECT + "}/settings/guidelines")
public class ProjectGuidelinesPage
    extends ProjectSettingsDashboardPageBase
{
    private static final long serialVersionUID = 5889016668816051716L;

    public ProjectGuidelinesPage(PageParameters aParameters)
    {
        super(aParameters);
    }
    ...
    protected void onInitialize()
    {
        ...
        add(new ProjectGuidelinesPanel("panel", getProjectModel()));
    }
}

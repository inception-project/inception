...
public class MiraPosClassificationToolTest
{
    ...
    @Test
    public void testMiraPosClassifier()
        throws IOException
    {
        System.err.println("\n== Testing MiraPosClassifier");

        ClassifierConfiguration<MiraConfigurationParameters> classifierConf = 
                new de.tudarmstadt.ukp.inception.recommendation.imls.mira.pos.BaseConfiguration();
        classifierConf.setLanguage("en");

        ClassificationTool<MiraConfigurationParameters> ct = new MiraPosClassificationTool();
        ...
        Reporter.dumpResults(
                new File(testConf.getResultFolder(), "MiraPosClassifier" + testTimestamp + ".html"),
                testConf, results);
    }
        ...
        throws IOException, ResourceInitializationException
    {
        ...
        return posLoader.loadAnnotationObjects(reader, "PosValue");
    }
}

 ...
 */
package de.tudarmstadt.ukp.inception.recommendation.imls.lapps.config;
...
{
    @Bean
    public LappsGridRecommenderFactory lappsGridRecommenderFactory()
    {
        return new LappsGridRecommenderFactory();
    }
}

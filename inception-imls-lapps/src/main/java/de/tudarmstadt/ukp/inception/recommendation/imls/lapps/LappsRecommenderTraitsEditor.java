...
public class LappsRecommenderTraitsEditor
    extends Panel
{
    ...
    private @SpringBean LappsRecommenderFactory toolFactory;
    
    private final LappsRecommenderTraits traits;

    public LappsRecommenderTraitsEditor(String aId, IModel<Recommender> aRecommender)
    {
        super(aId, aRecommender);
        
        traits = toolFactory.readTraits(aRecommender.getObject());

        Form<LappsRecommenderTraits> form = new Form<LappsRecommenderTraits>(MID_FORM,
